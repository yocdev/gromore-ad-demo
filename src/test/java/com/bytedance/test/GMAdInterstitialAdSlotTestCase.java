 ...
 * banner配置单元测试
 */
public class GMAdInterstitialAdSlotTestCase {
//
//    @Test
...
//        map.put("1111","1111");
//
//        GMAdSlotInterstitial slotBanner = new GMAdSlotInterstitial.Builder()
...
//                .build();
//        GMInterstitialAd gmBannerAd = new GMInterstitialAd(activity, "11111");
