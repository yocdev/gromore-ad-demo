 ...
 */
public class TouTiaoNativeExpressAd extends GMCustomNativeAd {

    private static final String TAG = AppConst.TAG_PRE + TouTiaoNativeExpressAd.class.getSimpleName();

    private NativeExpressADView mNativeExpressADView;

    public TouTiaoNativeExpressAd(NativeExpressADView feedAd, GMAdSlotNative adSlot) {
